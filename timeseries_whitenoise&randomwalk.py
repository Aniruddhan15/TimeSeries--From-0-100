# -*- coding: utf-8 -*-
"""TimeSeries -WhiteNoise&RandomWalk.ipynb
...
random_schocks = np.random.normal(0,1,n)
random_walk = np.cumsum(random_schocks)

plt.figure(figsize=(14,8))
plt.plot(white_noise,label='White Noise',color='#FF914D')
plt.plot(random_walk,label='Random Walk',color='#FF914D')
